    ...
    <div class="tabs">
        ...
        <div class="tabsContent">
            <div>
                    ...
                    <ul class="toolBar">
                        <li>
                            <shiro:hasPermission name="pms:menu:add">
                                <a id="addMenu" class="add" href="${baseURL}/pms/menu/addUI" target="dialog" rel="input"
                                   width="600" height="400" title="添加菜单">
                                    <span>添加</span>
                                </a>
                            </shiro:hasPermission>
                        </li>
                        <li>
                            <shiro:hasPermission name="pms:menu:delete">
                                <a id="delMenu" class="delete" href="${baseURL}/pms/menu/delete" callback="navTabAjax"
                                   target="ajaxTodo" rel="inputMenu" title="确定执行该删除操作吗？">
                                    <span>删除</span>
                                </a>
                            </shiro:hasPermission>
                        </li>
                ...
                <div layoutH="78"
                     style="float: left; display: block; overflow: auto; width: 260px; border: solid 1px #CCC; line-height: 21px; background: #fff">${tree}</div>
