                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    ...
                                    <small><fmt:formatDate value="${rpUserInfo.createTime}"
                    ...
                    <form class="form-horizontal">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" id="oldPayPass" name="oldPayPass"
                                           value=""/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" id="newPayPass" name="newPayPass"
                                           value=""/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" id="newPayPass2" name="newPayPass2"
                                           value=""/>
                                </div>
                            </div>
